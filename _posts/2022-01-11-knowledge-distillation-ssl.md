...
{% include image.html url="../../../images/distillation_ssl/sl_vs_ssl.png" description="Self-supervised vs Supervised Pretraining" width=400 %}
...
{% include image.html url="../../../images/distillation_ssl/moco.png" description="MoCo training" width=700 %}
...
{% include image.html url="../../../images/distillation_ssl/soft_vs_hard.png" description="Shiba Inu dogs are known to have cat-like characteristics, soft labels can encode this by assigning some probability to the cat class." width=600 %}
...
{% include image.html url="../../../images/distillation_ssl/kd.png" description="Knowledge Distillation" width=700 %}
...
{% include image.html url="../../../images/distillation_ssl/seed.png" description="SEED" source="https://arxiv.org/abs/2101.04731" %}
...
{% include image.html url="../../../images/distillation_ssl/seed2.png" description="SEED training" width=700%}
...
{% include image.html url="../../../images/distillation_ssl/s_vs_sl_kd.png" description="Self-supervised KD with Supervised KD" width=900%}
