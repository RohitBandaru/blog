...
{% include image.html url="../../../images/domain_adaptation/framework.png" description="Framework for Adversarial Domain Adaptation"%}
...
{% include image.html url="../../../images/domain_adaptation/adda.png" description="The steps of ADDA" source="https://arxiv.org/abs/1702.05464"%}
...
{% include image.html url="../../../images/domain_adaptation/dann.png" description="DANN" source="https://arxiv.org/abs/1505.07818"%}
...
{% include image.html url="../../../images/domain_adaptation/translation.png" description="Example of translating a street view image (SVHN) to a handwritten image (MNIST)" %}

## [Image to Image translation](https://arxiv.org/abs/1712.00479)

{% include image.html url="../../../images/domain_adaptation/i2i.png" description="I2I network and losses" source="https://arxiv.org/abs/1712.00479"%}
...
{% include image.html url="../../../images/domain_adaptation/cycada.png" description="CyCADA networks and losses" source="https://arxiv.org/abs/1711.03213"%}
